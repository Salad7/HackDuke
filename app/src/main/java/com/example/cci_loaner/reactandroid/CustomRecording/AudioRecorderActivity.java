package com.example.cci_loaner.reactandroid.CustomRecording;
...
public class AudioRecorderActivity extends AppCompatActivity
    ...
    private EditText recordingTitleView;
    private SharedPreferences sharedPrefs;
    private int recording_interval = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = getSharedPreferences(
                getString(R.string.sharedprefs), Context.MODE_PRIVATE);        recording_interval = (sharedPrefs.getInt("interval",1) * 60)+60;
        Log.d("AudioRecorderActivity","Interval is "+recording_interval);
        ...
        if(savedInstanceState != null) {
            ...
            recordingTitleView.setText(getIntent().getStringExtra(AndroidAudioRecorder.EXTRA_RECORDING_TITLE));
        }
    ...
    protected void onStop() {
        super.onStop();
        Log.d("AudioRecorderActivity","onStop");
    }
...
//        } catch (Exception e){ }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Log.d("AudioRecorderActivity","saveMenuItem "+saveMenuItem.toString());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == android.R.id.home) {
            Log.d("AudioRecorderActivity","Saving");
            finish();
    ...
    private void selectAudio(int saveType) {
        Intent i = new Intent();
        stopRecording();
        if(recordingTitleView.getText().toString().length() > 0) {
            i.putExtra("recordingTitle", recordingTitleView.getText().toString());
        }
        if(saveType == 0){
            Log.d("AudioRecorderActivity","Recording by way of interval");
            setResult(0x04,i);

        }
        else if(saveType == 1){
            Log.d("AudioRecorderActivity","Recording by way of manual user input");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(isRecording) {
                    ...
                    if(recorderSecondsElapsed >= recording_interval){
                        selectAudio(0);
                    }
                } else if(isPlaying()){
